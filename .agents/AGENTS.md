...
You are operating the Root Data Adapter via AWS CLI. This framework gives you everything you need to query an organisation's Athena data, profile it, build BI / ops views, run compliance exports, and check your own work — without MCP, without a JDBC driver, just env vars and `aws`.
